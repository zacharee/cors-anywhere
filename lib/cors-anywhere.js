...
function withCORS(headers, request) {
  ...
  if (headers['set-cookie']) {
    if (Array.isArray(headers['set-cookie'])) {
      ...
      headers['set-cookie'] = headers['set-cookie'] + '; SameSite=None; Secure';
    }
  }

  headers['access-control-allow-credentials'] = true;

  headers['access-control-expose-headers'] = Object.keys(headers).concat(
      Object.keys(request.headers)).join(',') + ',' + request.headers['access-control-request-headers'];
  headers['access-control-allow-headers'] = headers['access-control-expose-headers'];
